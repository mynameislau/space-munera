...
function dart_precompiled($collectedClasses) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Maze.prototype = $desc;
  function Tile(x, y, obstacle, _hashcode, _str, _f, _g, _h, _parentIndex) {
    this.x = x;
    this.y = y;
  ...
  return [JS_CONST, Interceptor, JSBool, JSNull, JSArray, JSNumber, JSInt, JSDouble, JSString, Maze, Tile, ListIterator, IterableBase, ListQueue, _ListQueueIterator, bool, $double, Error, NullThrownError, ArgumentError, RangeError, UnsupportedError, StateError, ConcurrentModificationError, CyclicInitializationError, $int, List, Null, num, Object, String, StringBuffer, Symbole, Creature, Carte];
}
