...
["a_star_2d", "a_star_2d.dart", , M, {
  ...
  aStar2D: function(maze) {
    ...
    $open = H.setRuntimeTypeInfo([], [M.Tile]);
    $closed = H.setRuntimeTypeInfo([], [M.Tile]);
    M.hueristic(start, goal);
    $open.push(start);
    for (t1 = numColumns - 1, t2 = numRows - 1; t3 = $open.length, t3 > 0;) {
      bestCost = $open[0]._a_star_2d$_f;
      for (bestTileIndex = 0, i = 1; i < t3; ++i) {
        bestCost0 = $open[i]._a_star_2d$_f;
        ...
        for (newY = P.max(0, t6); newY <= P.min(t2, t7); ++newY) {
          ...
          if (t9) {
            ...
            if (!foundInOpen) {
              ...
              t8._h = t9;
              t8._a_star_2d$_f = t8._g + t9;
              $open.push(t8);
            }
          }
        }
    }
    return P.ListQueue$(null, M.Tile);
  },
  Maze: {
  ...
  Tile: {
    "^": "Object;x>,y>,obstacle,_hashcode,_str,_a_star_2d$_f,_g,_h,_parentIndex",
    toString$0: function(_) {
      return this._str;
    },
    get$hashCode: function(_) {
    ...
    $eq: function(_, tile) {
      ...
      return this.x === t1.get$x(tile) && this.y === t1.get$y(tile);
    }
  }
}],
...
["dart.async", "dart:async", , P, {
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "^": "Closure:39;box_1,listener_3,sourceValue_4,zone_5",
    call$0: function() {
      var e, s, exception, t1;
      try {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 44, 16, 17],
...
["", "shifumachine.dart", , Y, {
  "^": "",
  main: [function() {
    var pierre, feuille, ciseau, _plan, t1, t2, mirmignon, t3, t4, t5, solution, thrace;
    ...
    if (0 >= t2)
      return H.ioore(t1, 0);
    t1 = new Y.Carte(t2, t1[0].length, _plan);
    $.carta = t1;
    t1.log$0();
    ...
    t1 = document.querySelector("#btn");
    $.btn = t1;
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone($.carta.get$draw()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  Carte: {
    ...
    draw$1: [function(e) {
      P.print("draw !");
      $.get$context().callMethod$2("drawmap", [this.log$0()]);
    }, "call$1", "get$draw", 2, 0, 49, 2]
  }
},
1],
]);
...
function dart_precompiled($collectedClasses) {
  ...
  function Maze(tiles, start, goal) {
    this.tiles = tiles;
    this.start = start;
    this.goal = goal;
  }
  Maze.builtin$cls = "Maze";
  if (!"name" in Maze)
    Maze.name = "Maze";
  $desc = $collectedClasses.Maze;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Maze.prototype = $desc;
  function Tile(x, y, obstacle, _hashcode, _str, _a_star_2d$_f, _g, _h, _parentIndex) {
    this.x = x;
    this.y = y;
    this.obstacle = obstacle;
    this._hashcode = _hashcode;
    this._str = _str;
    this._a_star_2d$_f = _a_star_2d$_f;
    this._g = _g;
    this._h = _h;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Tile.prototype = $desc;
  Tile.prototype.get$x = function(receiver) {
    return this.x;
  };
  Tile.prototype.get$y = function(receiver) {
    return this.y;
  };
  ...
  function Symbole(nom, valeur) {
    this.nom = nom;
    this.valeur = valeur;
  }
  Symbole.builtin$cls = "Symbole";
  if (!"name" in Symbole)
    Symbole.name = "Symbole";
  $desc = $collectedClasses.Symbole;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Symbole.prototype = $desc;
  function Creature(nom, attaque, defense, alonge, x, y, carte) {
    this.nom = nom;
